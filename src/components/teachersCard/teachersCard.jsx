const TeacherCard = ({name, imageURL, education, email, interestAreas, asignatures, publications}) => {
    return (
        <>
        <div className="ml-10 mr-10">
          ...
          <div className="flex justify-center">
            ...
            <h3 className="text-xl font-bold mb-1"> Educación y formación académica concluida: </h3>
