...
const auth = new google.auth.GoogleAuth({
  credentials:  {
    ...
    "client_email": "service-laboratorio-unimet@laboratoro-quimica-unimet.iam.gserviceaccount.com",
    "client_id": "116811674597550422612",
    "auth_uri": "https://accounts.google.com/o/oauth2/auth",
    "token_uri": "https://oauth2.googleapis.com/token",
    "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
    "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/service-laboratorio-unimet%40laboratoro-quimica-unimet.iam.gserviceaccount.com",
...
async function getSheetData() {
  try {
    const range = 'Solicitud de reactivo: laboratorio de procesos de separación!A2:P'; 
