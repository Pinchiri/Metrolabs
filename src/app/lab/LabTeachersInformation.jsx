...
const LabTeachersInformation = () => {
    return (
        <>
            <p className="pl-10 pb-3 mt-10 flex justify-center mb-4 text-stratos px-4 text-3xl sm:text-3xl self-left tracking-tighter font-b612 font-bold" id="LabTeachersInformation">
                Nuestros Profesores
            </p>
