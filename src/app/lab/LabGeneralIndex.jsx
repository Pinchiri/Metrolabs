    ...
    <>
      ...
      <div className="flex-col align-start pl-8 pr-3  md:grid md:grid-cols-2 lg:flex lg:flex-row lg:justify-around ">
        <div className=" flex flex-row gap-8 mb-10">
          ...
          <div>
            <h3 className="text-lg font-bold">Ubicación del Laboratorio</h3>
            <p>• Dirección exacta.</p>
            <p>• Horarios de operación.</p>
            <p>• Mapa o croquis de ubicación.</p>
            <div
        ...
        <div className=" flex flex-row gap-8 mb-10">
          ...
          <div>
            <h3 className="text-lg font-bold">Nuestros profesores</h3>
            <p>• Sergio David Rosales Anzola.</p>
            <p>• Juan Bernardo Tovar Salas.</p>
            <p>• Miguel Manuel Pérez Hernández.</p>
            <p>• Jose Barriola.</p>
            <div
              className="flex flex-row gap-2 align-center font-bold mt-2 hover:text-manz-200"
        ...
        <div className=" flex flex-row gap-8 mb-10">
          ...
          <div>
            <h3 className="text-lg font-bold">Equipamiento Disponible</h3>
            <p>• Lista de instrumentos y máquinas.</p>
            <p>• Capacidad y especificaciones.</p>
            <p>• Disponibilidad y horarios de uso.</p>
            <div
              className="flex flex-row gap-2 align-center font-bold mt-2 hover:text-manz-200"
        ...
        <div className=" flex flex-row gap-8 mb-10">
          ...
          <div>
            <h3 className="text-lg font-bold">Normas de Seguridad.</h3>
            <p>• Uso obligatorio de batas, guantes.</p>
            <p>• Procedimientos en caso de emergencia.</p>
            <p>• Manejo y disposición de sustancias peligrosas.</p>
            <div
              className="flex flex-row gap-2 align-center font-bold mt-2 hover:text-manz-200"
